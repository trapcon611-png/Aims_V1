...
const getQuestionType = (q: any) => { 
    ...
    const isNumber = !isNaN(Number(ans)) && !['a','b','c','d'].includes(ans) && !ans.includes(','); 
      ...
      return (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
              <div className="bg-white p-8 rounded-2xl shadow-2xl flex flex-col items-center">
                  <div className="animate-spin text-blue-600 mb-4"><Loader2 size={32} /></div>
                                            ...
                                            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div className="p-4 rounded-xl border bg-blue-50 border-blue-200">
                                                        <p className="text-xs font-bold text-blue-500 uppercase tracking-widest mb-1">Correct Answer</p>
